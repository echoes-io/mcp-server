  ...
  describe('commands', () => {
    ...
    describe('stats', () => {
      ...
      it('outputs statistics from database', async () => {
        ...
        await db.upsertChapters([createChapter('bloom:1:1', 'bloom', 'Alice', 1000)]);
        db.close();
      ...
      it('filters by arc', async () => {
        ...
        await db.upsertChapters([
          createChapter('bloom:1:1', 'bloom', 'Alice', 1000),
          createChapter('work:1:1', 'work', 'Bob', 2000),
        ]);
        db.close();
      ...
      it('shows POVs sorted by count descending', async () => {
        ...
        await db.upsertChapters([
          createChapter('bloom:1:1', 'bloom', 'Alice', 1000),
          createChapter('bloom:1:2', 'bloom', 'Alice', 1000),
          createChapter('bloom:1:3', 'bloom', 'Bob', 500),
        ]);
        db.close();
